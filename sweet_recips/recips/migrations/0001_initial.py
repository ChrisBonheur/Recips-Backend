# Generated by Django 2.2.12 on 2020-07-23 07:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recips.Ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Recip',
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='_recip_ingredients_+', through='recips.Quantity', to='recips.Ingredient')),
            ],
            options={
